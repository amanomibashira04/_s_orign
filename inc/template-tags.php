...
if ( ! function_exists( '_s_orign_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function _s_orign_posted_on() {
...
if ( ! function_exists( '_s_orign_posted_by' ) ) :
	/**
...
if ( ! function_exists( '_s_orign_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function _s_orign_entry_footer() {
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', '_s_orign_orign' ),
						array(
							'span' => array(
								'class' => array(),
							),
...
if ( ! function_exists( '_s_orign_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function _s_orign_post_thumbnail() {
